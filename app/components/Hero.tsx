...
const STRIP_IMAGES = [
  { src: "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=420&h=260&q=70", alt: "હસ્તપ્રત" },
  { src: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=420&h=260&q=70", alt: "સંગીત" },
  { src: "https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&w=420&h=260&q=70", alt: "સિનેમા" },
  { src: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?auto=format&fit=crop&w=420&h=260&q=70", alt: "પુસ્તક" },
  { src: "https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&w=420&h=260&q=70", alt: "ફિલ્મ" },
  { src: "https://images.unsplash.com/photo-1455390582262-044cdead277a?auto=format&fit=crop&w=420&h=260&q=70", alt: "લેખન" },
  { src: "https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?auto=format&fit=crop&w=420&h=260&q=70", alt: "સ્વર" },
  { src: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=420&h=260&q=70", alt: "રંગભૂમિ" },
];
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-5 pb-10 pt-16 text-center sm:px-8 sm:pt-24">
        ...
        <p
          className="rise mt-5 font-guj text-s font-600 text-poppy-deep"
