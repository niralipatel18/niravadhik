...
export function SectionHead({
  guj, blurb, accent = "poppy",
}: {
  guj: string; blurb?: string; accent?: string;
}) {
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <span
            className="flex items-center gap-1 rounded-full px-3 py-1 font-guj text-xs font-600 opacity-0 transition-all duration-300 group-hover:opacity-100"
            style={{
              color: "var(--accent)",
