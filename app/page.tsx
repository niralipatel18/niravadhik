...
export default function Home() {
  return (
    <>
      ...
      {/* ── Strand hero cards — Sahitya + Cinema ── */}
              ...
              >
                <div className="absolute inset-0">
                  ...
                  <div
                    ...
                    style={{ background: `linear-gradient(160deg, ${hex}cc 0%, rgba(26,20,16,0.78) 100%)` }}
                  />
                </div>
                <div
                  className="absolute -right-8 -top-8 h-40 w-40 rounded-full opacity-30 blur-3xl transition-opacity duration-500 group-hover:opacity-55"
                  style={{ background: hex }}
                />
                <div className="relative flex h-full flex-col p-7" style={{ minHeight: 320 }}>
                  <Art className="w-16 sm:w-20" />
                  <div className="mt-auto pt-10">
                    <p className="font-mono text-[0.58rem] font-600 uppercase tracking-[0.24em] text-white/55">
                      {s.latin}
                    </p>
                    <h3 className="mt-1 font-guj text-4xl font-700 text-white drop-shadow">
                      {s.label}
                    </h3>
                    <p className="mt-2 font-guj text-sm leading-relaxed text-white/80">
                      {s.blurb}
                    </p>
                    <span className="mt-5 inline-block rounded-full border border-white/30 bg-white/10 px-4 py-1.5 font-mono text-xs font-600 text-white backdrop-blur-sm transition-all duration-300 group-hover:bg-white/20">
                      જુઓ · Explore →
                    </span>
                  </div>
                </div>
      ...
      <section className="mx-auto mt-20 max-w-6xl px-5 sm:px-8">
        <div className="mb-9">
          <div className="flex flex-wrap items-baseline gap-x-3">
            ...
            <span className="font-mono text-sm font-600 uppercase tracking-[0.18em] text-poppy">
              Our Initiatives
            </span>
          </div>
          ...
          {initiatives.map((ev) => {
            ...
            return (
              <div
                ...
                className="card group relative overflow-hidden rounded-2xl border border-line bg-paper"
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  <Image
                    src={ev.image}
                    alt={ev.titleEn ?? ev.title}
                    fill
                  ...
                  <div
                    className="absolute inset-0"
                    style={{ background: `linear-gradient(to top, ${hex}dd 0%, transparent 55%)` }}
                  />
                  <div className="absolute bottom-3 left-3 right-3">
                    ...
                    <p className="mt-1.5 font-guj text-lg font-700 leading-tight text-white drop-shadow">
                      {ev.title}
                    </p>
                  </div>
                  <div className="absolute right-3 top-3 rounded-full bg-black/40 px-2.5 py-0.5 font-mono text-[0.58rem] text-white/80 backdrop-blur-sm">
                    {ev.year}
                  </div>
                </div>
                <div className="p-4">
                  <p className="font-guj text-sm leading-relaxed text-ink-soft">
                    {ev.description}
                  </p>
                  <p className="mt-1 text-xs italic text-ink-soft/60">
                    {ev.descriptionEn}
                  </p>
                </div>
              </div>
      ...
      <section className="mx-auto mt-16 max-w-6xl px-5 sm:px-8">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #1a1410 0%, #2a1f1a 40%, #1a1410 100%)",
          }}
        >
          ...
          <div className="flex-1 pl-4">
            ...
            <p className="mt-1 font-mono text-xs font-600 uppercase tracking-[0.2em] text-saffron/80">
              {magazine.frequencyEn}
            </p>
            <p className="mt-3 max-w-lg font-guj text-base leading-relaxed text-white/70">
              {magazine.tagline}
            </p>
            <p className="mt-0.5 text-sm italic text-white/45">
              {magazine.taglineEn}
            </p>
          </div>
      ...
      <section className="mx-auto mt-16 max-w-6xl px-5 sm:px-8">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #e8462b, #f6a01a, #c2317f, #3a4ea8, #128a7d)",
        ...
        >
          ...
          <p className="relative mt-3 text-sm italic text-white/75">
            Become distinct from the world — through some form of art.
          </p>
        ...
        <section key={s.key} className="mx-auto mt-20 max-w-6xl px-5 sm:px-8">
          ...
          <div className="mt-8 text-center">
            <Link
              href={s.href}
              data-accent={s.accent}
              className="inline-block rounded-full border-2 px-6 py-2.5 font-mono text-xs font-600 uppercase tracking-[0.18em] transition-all duration-300 hover:text-white"
              style={{ borderColor: "var(--accent)", color: "var(--accent)" }}
            >
              બધું જુઓ · View All {s.latin} →
            </Link>
          </div>
        </section>
      ))}
      ...
      <section className="mx-auto mt-24 max-w-2xl px-5 pb-4 text-center sm:px-8">
        ...
        <p className="font-guj text-2xl font-700 text-ink">
          ગાંધીનગરથી — કળાની ભૂમિ
        </p>
        <p className="mt-2 text-sm italic text-ink-soft/75">
          From Gandhinagar — a ground for art.
        </p>
        <Link
          href="/about"
